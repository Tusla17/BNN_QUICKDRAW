...
def generate_fc2_luts():
    ...
    # 3 Nơ-ron tương ứng với 10 file HEX
    for i in range(10):
        filename = f"fc2_lut_{i}.txt"
        with open(filename, "w") as f:
            # Popcount của FC2 chỉ có thể nằm trong khoảng 0 -> 64
            for x in range(65):
        ...
        print(f"✅ Đã tạo xong {filename} (65 giá trị lượng tử 64-bit)")
